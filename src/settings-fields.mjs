...
export const SETTINGS_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'audio.style', label: '可视化样式', type: 'enum', options: [{ value: 'ribbon', label: '镜面丝带' }, { value: 'bars', label: '柱状' }, { value: 'wave', label: '波形' }, { value: 'mirror', label: '对称' }] },
      ...
      { key: 'audio.barCount', label: '柱数', type: 'number', min: 16, max: 72, step: 4, description: 'bars 样式有效' },
      { key: 'audio.mirrored', label: '镜像', type: 'boolean', description: 'bars/wave 是否镜像左右声道' },
...
export const SETTINGS_SECTIONS = Object.freeze({
  ...
  audio: Object.freeze([
    ...
    { id: 'audio-style', title: '样式', fieldKeys: Object.freeze(['audio.style', 'audio.position', 'audio.height', 'audio.barCount', 'audio.mirrored']) },
