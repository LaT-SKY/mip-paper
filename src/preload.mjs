...
import { FULLSCREEN_UPDATED_CHANNEL, GET_WORK_AREA_CHANNEL, MENU_CLOSE_CHANNEL, MENU_COMMAND_CHANNEL, MENU_OPENED_CHANNEL, NOTIFY_MENU_OPENED_CHANNEL, WORK_AREA_UPDATED_CHANNEL } from './window-manager.mjs';
